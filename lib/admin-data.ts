...
export const adminClients: AdminClient[] = [
  {
    ...
    seatsUsed: 12,
    lastAccess: "Hoy 09:14",
    notes: "Cliente estrella con crecimiento explosivo. Redujo merma en 35% usando IA - ahorro de €15,000 mensuales. Caso de éxito perfecto para demos.",
    tags: ["caso exito", "reduccion merma 35%", "ahorro €15k/mes", "demo premium"],
  ...
  },
  {
    ...
    seatsUsed: 45,
    lastAccess: "Hoy 08:42",
    notes: "Franquicia en expansion rapida - 8 locales nuevos en 6 meses. Un local con retrasos criticos, pero el resto opera perfectamente. Potencial de €50k en ahorros anuales.",
    tags: ["expansion rapida", "8 locales nuevos", "potencial €50k ahorro", "soporte urgente"],
  ...
  },
  {
    ...
    seatsUsed: 32,
    lastAccess: "Hoy 06:58",
    notes: "SITUACION CRITICA: API de POS vencida causando perdidas de €8,000 semanales. Local principal con incidencia operativa - riesgo de cierre. Requiere intervencion inmediata.",
    tags: ["emergencia", "perdidas €8k/semana", "API vencida", "riesgo cierre", "prioridad maxima"],
  ...
  },
  {
    ...
    seatsUsed: 8,
    lastAccess: "Hoy 09:02",
    notes: "Panaderia boutique con crecimiento organico impresionante. De 2 empleados a 8 en 3 meses. Merma reducida 25% automaticamente. Listos para upgrade premium.",
    tags: ["crecimiento organico", "merma -25%", "upgrade premium", "expansion rapida"],
  ...
  },
  {
    ...
    seatsUsed: 20,
    lastAccess: "Hoy 08:27",
    notes: "Startup saludable en crecimiento. De concepto a 3 locales en 8 meses. Merma reducida 40% con IA predictiva. Problema: 2FA pendiente en manager - riesgo de seguridad.",
    tags: ["startup exito", "merma -40%", "expansion rapida", "2FA pendiente", "seguridad critica"],
